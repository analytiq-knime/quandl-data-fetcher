 ...
 * @author I Tang Lo
 */
public class QuandlEODNodePlugin extends Plugin {
    // The shared instance.
    private static QuandlEODNodePlugin plugin;

    /**
     * The constructor.
     */
    public QuandlEODNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QuandlEODNodePlugin getDefault() {
        return plugin;
    }
